package net.leonemc.lithium.utils.command;
...
public class CommandFramework implements CommandExecutor {
        ...
        for (int i = args.length; i >= 0; i--) {
            ...
            if (commandMap.containsKey(cmdLabel)) {
                ...
                try {
                    ...
                    } else method.invoke(methodObject, new CommandArgs(sender, cmd, label, args,
                            cmdLabel.split("\\.").length - 1));
    ...
    private void defaultCommand(CommandArgs args) {
        args.getSender().sendMessage(args.getLabel() + " is not handled... Please notify a developer.");
    }
}
