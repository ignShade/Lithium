package net.leonemc.lithium.utils.menu.menus;

import java.util.HashMap;
import java.util.Map;

import net.leonemc.lithium.utils.TypeCallback;
import net.leonemc.lithium.utils.menu.Button;
import net.leonemc.lithium.utils.menu.Menu;
import net.leonemc.lithium.utils.menu.button.ConfirmationButton;
